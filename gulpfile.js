...
gulp.task('concat-and-minify', function(done) {
  ...
  .pipe(uglify())
  .pipe(concat("name-of-system.min.js"))
...
gulp.task('pl-assets', gulp.series(
  ...
  'svg-sprite',
  'pl-copy:font',
  gulp.series('pl-sass', 'pl-copy:css', function(done){done();}), //CSS tasks
  'pl-copy:styleguide',
